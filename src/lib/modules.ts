export type ModuleId =
    | "M00" | "M10" | "M11" | "M12" | "M20"
    | "M30" | "M31" | "M40" | "M50" | "M51" | "M52" | "M60"
    | "M61" | "M90" | "M91" | "M92" | "M99" | "M21";
...
export const MODULES: Record<ModuleId, ModuleDefinition> = {
    ...
    M21: { id: "M21", name: "個別相談・セミナー設計", description: "成約率を最大化する導線設計", category: "strategy" },
    ...
    M51: { id: "M51", name: "コピーライティング", description: "売れる文章×AIプロンプト設計", category: "execution" },
    M52: { id: "M52", name: "X投稿・記事拡散", description: "教育マーケティング×拡散設計", category: "execution" },
